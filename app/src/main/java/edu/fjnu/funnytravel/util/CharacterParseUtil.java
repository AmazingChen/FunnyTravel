...
public class CharacterParseUtil {
    ...
    private static CharacterParseUtil charParseUtil = new CharacterParseUtil();

    public static CharacterParseUtil getInstance() {
        return charParseUtil;
    }
     ...
     * @return
     */
    private int changeChineseToASCII(String chinese) {
        int asc = 0;
        try {
            ...
            if(bytes.length == 2) {
                ...
                asc = (hightByte * 256 + lowByte) - 256 * 256;
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String convert(String str) {
        String result = null;
        int ascii = changeChineseToASCII(str);
    ...
    public String getSelling() {
        return this.getSelling(getResource());
    }
